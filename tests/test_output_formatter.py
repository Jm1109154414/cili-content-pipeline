...
STRATEGY = {"posts": [{"fecha": "2026-07-01", "plataforma": "Instagram", "tipo": "imagen_sola", "objetivo": "educacion"}]}
COPIES = {"posts": [{"gancho": "Gancho de prueba", "copy_completo": "Texto completo", "hashtags": ["#lean"], "cta": "Agenda tu diagnóstico"}]}
...
def test_generate_output_crea_archivos(tmp_path):
    ...
    salidas = generate_output(STRATEGY, COPIES, IMAGE_RESULTS, brief, tmp_path)
